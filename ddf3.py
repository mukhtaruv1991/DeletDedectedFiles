...
def find_target_folders(root_path, target_folder_name):
    ...
    # نستخدم set لتجنب حذف مجلد داخل مجلد آخر تم حذفه
    visited = set()
    ...
    for dirpath, dirnames, filenames in os.walk(root_path):
        if target_folder_name in dirnames:
            ...
            # تحقق مما إذا كان المجلد الحالي داخل مجلد تم تحديده مسبقًا
            if any(folder_path.startswith(parent + os.sep) for parent in visited):
                continue
